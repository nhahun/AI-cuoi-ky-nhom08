...
"""
Remap dataset ngoài từ 6 class về 4 class tương thích với bài toán hiện tại.
...
Kết quả đầu ra là một YOLO dataset 4 class mới để tiếp tục merge với dataset gốc.
"""
