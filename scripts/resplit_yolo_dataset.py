...
"""
Chia lại YOLO dataset theo base image để tránh leakage giữa các split.

Script này phù hợp khi dataset có nhiều ảnh augment hoặc nhiều file cùng sinh ra
từ một ảnh gốc. Thay vì chia từng file riêng lẻ, script sẽ:
- gom ảnh theo base image,
- chia theo tỉ lệ train/valid/test,
- copy dữ liệu sang thư mục output,
- tạo lại data.yaml để có thể train ngay.
"""
