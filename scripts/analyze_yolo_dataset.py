...
"""
Phân tích một dataset YOLO và in báo cáo JSON ra console.

Script này dùng để kiểm tra nhanh:
- số ảnh, số label và số box của từng split,
- phân bố class để phát hiện mất cân bằng dữ liệu,
- các dòng label lỗi format hoặc class id sai,
- mức độ trùng base image giữa train/val/test để phát hiện leakage.
"""
